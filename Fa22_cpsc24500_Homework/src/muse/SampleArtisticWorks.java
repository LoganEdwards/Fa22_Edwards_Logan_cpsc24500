...
public static ArrayList<ArtisticWork> generate() {
	...
	poem = new Poem("Phoebe B.","2022-11-04","Roses Are Blue", "A poem about hazy confusion and the meaninglessnessof it all.","English","This poem is flowin' like phloem // and I be knowin what be stolen from you.","iambicpentameter");
	...
	movie.addComment("Katie Kline","Oct. 26, 2022", "I laughed, I cried, I vomitedbecause I was sick.");
